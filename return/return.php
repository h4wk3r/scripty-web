...
<header class="text-center" name="home">
  <div class="intro-text">
    <br>
    <h1><FONT size="6pt">List of <span class="color">return codes</span></FONT></h1>
    <br>
</header>
...
<div id="services-section1">
	...
	<div class=list>
        	<div class=tab1>
				...
				<center><h1>
				<FONT size="5pt">Search <span class="color">Code</span></FONT></h1></center>
        	                CODE : <input type="text" class="form" name="key">
		...
		<div class=tab1>
			...
			<form action="check.php" class="form" method="post">
				<center><h1><FONT size="5pt">Add <span class="color">Code</span></FONT></h1></center>
				<div class=tab2>
					CODE : <input type="text" class="form2" name="code">
				</div>
				<div class=tab2>
					DESCRIPTION : <input class="form2" type="text" name="description">
				</div>
				<input type="submit" class="form-btn semibold" name="Ajouter" value="Ajouter">
				</form>
		</div>
		...
		<div class=tab1>
			...
			<center><h1>
				<FONT size="5pt">Delete <span class="color">Code</span></FONT></h1></center>
        			CODE : <input type="text" class="form" name="key">
		...
		<?php
			...
			$query = "SELECT code,description FROM error_code ORDER BY code ASC";
