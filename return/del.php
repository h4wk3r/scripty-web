...
<header class="text-center" name="home">
  <div class="intro-text">
    <br>
    <h1><FONT size="6pt">DELETE CODE <span class="color">RETURN</span></FONT></h1>
    <br>
</header>
...
<?php
        ...
        $query = "DELETE FROM error_code WHERE code = $code";
        ...
        echo "<br>";
        echo "Le Code d'erreur <b>$code</b> a été supprimé la base";
        }
        pg_close($conn);
?>
