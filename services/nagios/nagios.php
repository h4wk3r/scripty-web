  ...
  <div class="container">
    ...
    <div class="section-title">
	     <div class="contact-form">
	       <!-- Form -->
	        <form id="contact-us" method="post" action="nagios-install.php">
  	        <div class="col-xs-6 wow animated slideInLeft" data-wow-delay=".5s">
			    <h2><FONT size="5pt">Information <span class="color">Client NAGIOS</span></FONT></h2>
			    ...
			    <br><br>
			    <h2><FONT size="5pt">Information <span class="color">Serveur NAGIOS</span></FONT></h2>
			    <input type="text" name="ip_server" id="ip_server" required="required" class="form" placeholder="IP / NAME SERVER NAGIOS" />
                            <input type="password" name="password_nagios" id="password_nagios" required="required" class="form" placeholder="PASSWORD SERVER NAGIOS" />
                            <input type="text" name="namehost" id="namehost" required="required" class="form" placeholder="VISIBLE NAME ON INTERFACE NAGIOS" />
  		      </div>
            	      <div class="col-xs-6 wow animated slideInRight" data-wow-delay=".5s">
  		             <img src="../../img/services/nagios.jpg" alt="Smiley face" height="325" width="500">
  		      </div>
