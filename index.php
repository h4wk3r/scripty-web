...
<header class="text-center" name="home">
  <div class="intro-text">
    <br>
    <br>
    <h1>Scripty <span class="color">Web</span></h1>
    <br>
    <br>
    <p>Déployer des services automatiquement sur vos serveurs.</p>
	<br>
</header>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-3 col-sm-6 service"> <i class="fa fa-file-text-o"></i>
        <h4><a href="services/ldap/ldap.php">Client Ldap</a></h4>
        <p>Deploiement automatique du client LDAP: Installation du client Ldap</p>
      </div>
      ...
      <div class="col-md-3 col-sm-6 service"> <i class="fa fa-camera"></i>
        <h4><a href="services/nagios/nagios.php">Client Nagios</a></h4>
        <p>Deploiement automatique du client NAGIOS: Installation du client pluggins-nagios et du client nrpe</p>
      </div>
    </div>
  </div>
</div>
