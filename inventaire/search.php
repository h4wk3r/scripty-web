...
<header class="text-center" name="home">
  <div class="intro-text">
    <br>
    <h1><FONT size="6pt">SEARCH CODE <span class="color">RETOUR</span></FONT></h1>
    <br>
</header>
...
<div id="services-section1">
	<div class=list2>
		<?php
			...
			$query = "SELECT id,server_name,owner,service1,service2,service3,service4,service5,client_ldap,client_ansible,client_nagios FROM inventory WHERE server_name='$code'";
